...
outFolder <- paste(
    c('../..', '/outputs/0.05/dpulex4dDMSOM4/vsn_lpe'),
    collapse='')
...
h_norm <- c("LFQ.intensity.DMSO.4d.I.1", "LFQ.intensity.DMSO.4d.J.1", 
            "LFQ.intensity.M4.4d.C.1", "LFQ.intensity.M4.4d.D.1")
...
> Fc = median(3:M4,4:M4)/median(1:DMSO,2:DMSO)
```{r echo=FALSE, warning=FALSE}
# > Fc = median(1:DMSO,2:DMSO)/median(7:M4,8:M4)
# > Fc = median(1:DMSO,2:DMSO)/median(5:Concentration 2,6:Concentration 2)
