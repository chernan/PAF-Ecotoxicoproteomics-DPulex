...
outFolder <- paste(
    c('../..', '/outputs/0.05/dpulex2dDMSOC2/vsn_lpe'),
    collapse='')
...
h_norm <- c("LFQ.intensity.DMSO.2d.G.1", "LFQ.intensity.DMSO.2d.H.1", 
            "LFQ.intensity.Tamox.C2.2d.Pp.1", "LFQ.intensity.Tamox.C2.2d.Q.1")
...
1 | DMSO (Control)
2 | DMSO (Control)
3 | C2 (Concentration 2)
4 | C2 (Concentration 2)
...
> Fc = median(3:C2,4:C2)/median(1:DMSO,2:DMSO)
